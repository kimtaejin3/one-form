...
_NOTIFICATIONS = [
    ...
    {"id": 4, "type": "시스템", "title": "입사지원서 저장됨", "message": "토스 지원용 이력서·자기소개서가 저장됐어요.", "time": "어제", "unread": False},
    ...
    {"id": 7, "type": "시스템", "title": "제출용 PDF 준비 완료", "message": "이력서·경력기술서를 한 파일로 묶었어요.", "time": "3일 전", "unread": False},
